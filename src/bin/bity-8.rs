...
fn main() {
    ...
    if args.len() < 2 {
        ...
        for i in 0..5*90 {
            em.channels[0].play_note(&mut em.mem, i, 0, 15);
            em.channels[1].play_note(&mut em.mem, i, 1, 15);
            em.channels[2].play_note(&mut em.mem, i, 2, 15);
            em.channels[3].play_note(&mut em.mem, i, 3, 15);
